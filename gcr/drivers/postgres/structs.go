...
func BuildPool(ctx context.Context, databaseUrl string) (gcr.SqlResource, error) {
...
func (p *postgresResource) Executor() gcr.SqlExecutor {
	return p
}

func (p *postgresResource) Begin(ctx context.Context) (gcr.SqlTxResource, error) {
...
func (p *postgresResource) Syntax() gcr.SqlSyntax {
...
func (p *postgresResource) Exec(ctx context.Context, sql string, args ...any) (gcr.SqlResult, error) {
	if p.tx != nil {
...
func (p *postgresResource) Query(ctx context.Context, sql string, args ...any) (gcr.SqlRows, error) {
	if p.tx != nil {
...
func (p *postgresResource) QueryRow(ctx context.Context, sql string, args ...any) gcr.SqlRow {
	if p.tx != nil {
